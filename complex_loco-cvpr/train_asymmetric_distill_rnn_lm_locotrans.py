...
from utils.process_asymmetric_distill_rnn_lm_locotrans import process_asymmetric_distill_rnn_lm_locotrans_trainer
...
def train():
  ...
  distiller = process_asymmetric_distill_rnn_lm_locotrans_trainer(
