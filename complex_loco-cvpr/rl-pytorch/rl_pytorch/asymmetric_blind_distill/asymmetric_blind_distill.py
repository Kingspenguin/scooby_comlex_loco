...
class AsymmetricBlindDistillTrainer:
  def __init__(
      self,
      vec_env,
      actor_critic_class,
    ...
    self.student_actor_critic = actor_critic_class(
      student_encoder, (self.vec_env.task.state_obs_size -
                        self.vec_env.task.privilege_info_len, ), self.state_space.shape, self.action_space.shape,
