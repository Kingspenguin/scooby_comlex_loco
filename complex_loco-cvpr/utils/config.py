...
def get_args(benchmark=False, use_rlg_config=False):
  custom_parameters = [
      ...
      {"name": "--get_statistics", "action": "store_true", "default": False,
          "help": "Get statistics of the evaluation"},
      {"name": "--log_video", "action": "store_true", "default": False,
          "help": "Log video"},
      {"name": "--vid_log_step", "type": int, "default": 2000,
      ...
      {"name": "--wandb_resume", "type": bool, "default": None,
          "help": "wandb resume"},
      {"name": "--learn_value_by_self", "action": "store_true", "default": False,
          "help": "Run trained policy, no training"},
      {"name": "--learn_by_self", "action": "store_true", "default": False,
          "help": "Run trained policy, no training"},
      {"name": "--use_pretrain_encoder", "action": "store_true", "default": False,
          "help": "Run trained policy, no training"},
      {"name": "--hard_terrain", "action": "store_true", "default": False,
          "help": "use hard terrain or not"},
      {"name": "--teacher_resume", "type": int, "default": 0,
          "help": "Resume training or start testing from a checkpoint"},
      ...
      {"name": "--task", "type": str, "default": "Robot",
      ...
      {"name": "--vidlogdir", "type": str, "default": "videos/"},
      {"name": "--logdir", "type": str, "default": "logs/"},
      {"name": "--pretrain_encoder_dir", "type": str, "default": "logs/"},
      {"name": "--tracking_cam_viz", "action": "store_true", "default": False},
      {"name": "--teacher_logdir", "type": str, "default": "logs/"},
      {"name": "--storage_save_path", "type": str, "default": "logs/storage"},
      {"name": "--storage_load_path", "type": str, "default": "logs/storage"},
      ...
      {"name": "--statistics_logdir", "type": str, "default": "statistics/"},
      {"name": "--num_envs", "type": int, "default": 0,
          "help": "Number of environments to create - override config file"},
      {"name": "--test_episodes", "type": int, "default": 10,
          "help": "How many episodes to run in test mode"},
      {"name": "--test_id", "type": str, "default": "all",
          "help": "extra_test_id"},
      ...
      {"name": "--mask_base_vel", "action": "store_true", "default": False,
          "help": "mask the chilren's base velocity term in observation"},
      {"name": "--add_label", "type": str,
