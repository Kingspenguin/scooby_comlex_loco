...
from rl_pytorch.distill_lm_full import DistillLMFullLocoTransTrainer, ActorCriticLMFull


def process_distill_lm_full_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = DistillLMFullLocoTransTrainer(
      vec_env=env,
      teacher_actor_critic_class=ActorCritic,
      student_actor_critic_class=ActorCriticLMFull,
