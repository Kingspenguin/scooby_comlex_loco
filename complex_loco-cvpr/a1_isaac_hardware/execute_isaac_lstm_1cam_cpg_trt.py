import numpy as np
from control_loop_execution.locotrans_trt_policy_wrapper import LocotransTRTGRUPolicyWrapper
from control_loop_execution.lstm_cpg_rl_policy_wrapper_trt import LSTMCPGTRTPolicyWrapper
...
from control_loop_execution.lstm_executor_trt import LSTMTRTExecutor
...
if __name__ == "__main__":
  ...
  PARAM_PATH = os.path.join(args.logdir, "locotransformer_1cam_gru_dr_1.trt")
  ...
  actor_critic = LocotransTRTGRUPolicyWrapper(
      PARAM_PATH,
      55,
      (1, 64, 64),
      256, 2,  # hidden dim & num layers
      16,
  )
  obs_scale = {
      "base_ang": 1,
  ...
  # exit()
  policyComputer = LSTMCPGTRTPolicyWrapper(
      actor_critic,
      obs_scale,
      get_image_interval,
      save_dir_name=save_dir_name,
