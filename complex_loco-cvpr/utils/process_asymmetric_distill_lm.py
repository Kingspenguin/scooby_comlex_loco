...
from rl_pytorch.asymmetric_distill_lm import AsymmetricDistillLMLocoTransTrainer, ActorCriticLM


def process_asymmetric_distill_lm_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = AsymmetricDistillLMLocoTransTrainer(
      vec_env=env,
