...
from rl_pytorch.rma import RMAStudent


def process_rma_student_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = RMAStudent(vec_env=env,
                       ...
                       value_loss_coef=learn_cfg.get(
                         "value_loss_coef", 2.0),
                       hidden_loss_coef=learn_cfg.get(
