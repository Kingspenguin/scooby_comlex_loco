...
class LMRolloutStorage:
  ...
  def __init__(
      ...
      actions_shape, hidden_state_size,
      hidden_state_num, teacher_feature_shape, device='cpu', sampler='sequential'
  ):
    ...
    self.hidden_states = torch.zeros(
        num_transitions_per_env, hidden_state_num,
  ...
  def add_transitions(
      ...
      mu, sigma, hidden_states,
      teacher_actions, teacher_features
  ):
