...
from rl_pytorch.asymmetric_distill_rnn_lm_locotrans import AsymmetricDistillRNNLMLocoTransTrainer, RecurrentActorCriticLM


def process_asymmetric_distill_rnn_lm_locotrans_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = AsymmetricDistillRNNLMLocoTransTrainer(
      vec_env=env,
      teacher_actor_critic_class=ActorCritic,
      student_actor_critic_class=RecurrentActorCriticLM,
