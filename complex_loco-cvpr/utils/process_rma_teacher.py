...
from rl_pytorch.ppo import get_encoder
from rl_pytorch.rma import RMAActorCritic
from rl_pytorch.rma import RMATeacher


def process_rma_teacher_trainer(args, env, cfg_train, logdir):
  ...
  trainer = RMATeacher(vec_env=env,
  ...
  if is_testing:
    ...
    trainer.test_student("{}/model_{}.pt".format(logdir, chkpt))
  elif chkpt > 0:
    print("Loading model from {}/model_{}.pt".format(logdir, chkpt))
    trainer.student_load("{}/model_{}.pt".format(logdir, chkpt))
