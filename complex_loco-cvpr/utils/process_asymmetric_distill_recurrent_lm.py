...
from rl_pytorch.asymmetric_distill_recurrent_lm import AsymmetricDistillRecurrentLMTrainer, RecurrentActorCriticLM


def process_asymmetric_distill_recurrent_lm_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = AsymmetricDistillRecurrentLMTrainer(
      vec_env=env,
