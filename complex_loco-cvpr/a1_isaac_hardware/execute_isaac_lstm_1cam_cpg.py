...
from control_loop_execution.cpg_lstm_executor_v2 import CPGLSTMExecutorV2
from control_loop_execution.lstm_cpg_rl_policy_wrapper_v2 import LSTMCPGPolicyWrapperV2
import os
import sys
...
if __name__ == "__main__":
  ...
  # exit()
  policyComputer = LSTMCPGPolicyWrapperV2(
      actor_critic,
      obs_scale,
      get_image_interval,
      save_dir_name=save_dir_name,
