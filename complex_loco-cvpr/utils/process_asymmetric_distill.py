...
from rl_pytorch.asymmetric_distill import AsymmetricDistillTrainer


def process_asymmetric_distill_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = AsymmetricDistillTrainer(vec_env=env,
