...
if __name__ == '__main__':
    ...
    while True:
        ...
        if( motiontime >= 500):
            ...
            torque = (0 - state.motorState[d['FL_1']].q)*10.0 + (0 - state.motorState[d['FL_1']].dq)*1.0
            speed = 2 * math.sin(3*math.pi*Tpi/2000.0)

            # cmd.motorCmd[d['FL_2']].q = PosStopF
            cmd.motorCmd[d['FL_0']].q = 0
            cmd.motorCmd[d['FL_0']].dq = speed
            cmd.motorCmd[d['FL_0']].Kp = 0
            cmd.motorCmd[d['FL_0']].Kd = 4
            cmd.motorCmd[d['FL_0']].tau = torque
            
            cmd.motorCmd[d['FL_1']].q = 0.9
            cmd.motorCmd[d['FL_1']].dq = speed
            cmd.motorCmd[d['FL_1']].Kp = 0
            cmd.motorCmd[d['FL_1']].Kd = 4
