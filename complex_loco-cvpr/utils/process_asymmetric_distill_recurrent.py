...
from rl_pytorch.asymmetric_distill_recurrent import AsymmetricDistillRecurrentTrainer, RecurrentActorCritic


def process_asymmetric_distill_recurrent_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = AsymmetricDistillRecurrentTrainer(vec_env=env,
                                              teacher_actor_critic_class=ActorCritic,
                                              student_actor_critic_class=RecurrentActorCritic,
