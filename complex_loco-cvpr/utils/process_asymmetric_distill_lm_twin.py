...
from rl_pytorch.asymmetric_distill_lm_twin import AsymmetricDistillLMLocoTransTwinTrainer, ActorCriticLMTwin


def process_asymmetric_distill_lm_twin_trainer(args, env, cfg_train, teacher_logdir, student_logdir):
  ...
  trainer = AsymmetricDistillLMLocoTransTwinTrainer(
      vec_env=env,
      teacher_actor_critic_class=ActorCritic,
      student_actor_critic_class=ActorCriticLMTwin,
      ...
      bc_loss_coef=learn_cfg.get(
          "bc_loss_coef", 1.0),
      pd_from_cpg_bc_loss_coef=learn_cfg.get(
          "pd_from_cpg_bc_loss_coef", 0.0),
      ...
      alternate_sampling=learn_cfg.get(
